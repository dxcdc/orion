/**
* Theme: Lahomes - Responsive Bootstrap 5 Admin Dashboard
* Author: Techzaa
...
class Config {
     ...
     setConfig() {
          ...
          var savedConfig = localStorage.getItem("__Lahomes_CONFIG__");
          // var savedConfig = sessionStorage.getItem("__Lahomes_CONFIG__");
     ...
     init() {
          try {
               ...
               localStorage.setItem('__Lahomes_CONFIG__', JSON.stringify(this.config));
               this.setConfig();
          }
     }
}
